...
SEEDS = {
    "dwt_roundtrip": {
        ...
        "seed-db38-antireflect-odd.bin": bytes([37, 7])
        + samples(list(range(-8, 9))),
        "seed-db2-periodization-f32.bin": bytes([1, 0x80 | 8])
        + samples([1, -2, 3, -4, 5, -6, 7, -8]),
        "seed-sym20-smooth-even.bin": bytes([56, 5])
        + samples(list(range(-16, 16))),
    },
    "wavedec_roundtrip": {
        "seed-empty.bin": b"",
        ...
        "seed-sym20-max.bin": bytes([56, 8, 0x80])
    ...
    "custom_filter_bank": {
        ...
        "seed-nonfinite.bin": bytes([4, 8, 9])
        + struct.pack("<Q", 0x3FF0000000000000),
    },
}
